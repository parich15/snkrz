    ...
    <div class="container px-8 py-24 mx-auto flex flex-wrap">
      ...
      <div class="md:w-3/5 md:pl-6">
        ...
        <div class="flex md:mt-4 mt-6 sm:flex-row flex-col items-center sm:items-start">
          <button class="w-5/12 sm:w-auto font-brand inline-flex transition duration-200 ease-in  text-white bg-green-600 border-0 py-1 px-4 focus:outline-none hover:bg-gray-700 hover:text-green-600 rounded">
            Newsletter
          </button>
        </div>
      </div>
